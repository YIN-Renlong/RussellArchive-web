...
**Course:** ISI (Information Systems Implementation)  
**Student:** Renlong YIN  
**Date:** December 2025  

## 🎮 Play Online (Web Version)
**[👉 Click here to launch The Russell Archive in your browser](https://yin-renlong.github.io/RussellArchive-web/)**
...
### 2. Dataset Selection
*   **Requirement:** At least 3 tables and 1 Foreign Key.
...
*   **Compliance:** `Events` contains a **Foreign Key** (`location_id`) linking to the `Locations` table.

### 3. Story & Query Quantity
...
### 4. Technical Workflow (Python to Ren'Py)
...
### 7. SQL Constraints (The "Hard" Requirements)
...
## 🤖 AI Declaration
*In accordance with KU Leuven guidelines:*
